export const namesHints = {
  ...
  ownedSince: 'Estimated date, time, and block height when the account became the owner of the Name.',
  status: 'Current state of the Name in the blockchain.',
  customPointers: 'User-defined pointers that can point to any valid value.',
  ...
  eventTransactionHash: 'Transaction hash that triggered the name event.',
  eventTime: 'Estimated date, time, and block height when the event was triggered.',
