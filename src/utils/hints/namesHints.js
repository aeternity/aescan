export const namesHints = {
  ...
  expired: 'Block height and estimated date and time when the Name was detached from the account. After expiration, the name entered into a revoked state and can be claimed again after a fixed timeout of 2016 keyblocks.',
  ...
  activationTime: 'Block height and date and time when the Name was activated.',
