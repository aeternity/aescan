export const namesHints = {
  ...
  expireHeight: 'Keyblock height when the name will be detached from the account. After expiration, the name enters into a revoked state and can be claimed again after a fixed timeout of 2016 keyblocks.',
  expire: 'Estimated date and time when the name will be detached from the account. After expiration, the name enters into a revoked state and can be claimed again after a fixed timeout of 2016 keyblocks.',
  ...
  highestBid: 'Account of the highest bidder.',
  highestBidder: 'Highest bid price. Required minimum bid increase is 5%.',
  bidCount: 'Amount of bids in the auction.',
  endHeight: 'Keyblock height when the auction ends.',
  end: 'Estimated date and time when the auction ends.',
  expiredHeight: 'Keyblock height when the name has been detached from the account. After expiration, the name entered into a revoked state and can be claimed again after a fixed timeout of 2016 keyblocks.',
  expired: 'Estimated date and time when the name has been detached from the account. Name passed revoked period and can be claimed again.',
