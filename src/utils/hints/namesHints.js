export const namesHints = {
  ...
  revokedTime: 'Estimated date and time when the name has been detached from the account and entered revoked period.',
  ...
  state: 'Current state of the name. The possible states are: Active, In Auction, Expired or Revoked. Name can have multiple states at the same time.',
