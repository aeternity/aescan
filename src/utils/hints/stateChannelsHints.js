export const stateChannelsHints = {
  ...
  lastUpdateHeight: 'Keyblock height of the last on-chain interaction with the state channel.',
  lastUpdate: 'Exact date and time of the last on-chain interaction with the state channel.',
