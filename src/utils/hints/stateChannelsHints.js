export const stateChannelsHints = {
  ...
  initiatorCreateAmount: 'The amount of AE coins that was deposited to the state channel by initiator at creation.',
  initiatorCloseAmount: 'The amount of AE coins that was redistributed back to initiator.',
  responderCreateAmount: 'The amount of AE coins that was deposited to the state channel by responder at creation.',
  responderCloseAmount: 'The amount of AE coins that was redistributed back to responder.',
  ...
  depositRound: 'The round in which the deposit to the state channel was made.',
  depositAmount: 'Amount deposited to the state channels.',
  withdrawRound: 'The round in which the withdrawal from the state channel was made.',
  ...
  sentBy: 'The account that initiated the channel to be closed.',
