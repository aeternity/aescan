export const stateChannelsHints = {
  ...
  lastKnownRound: 'Operations in State Channels are executed in Rounds, where each action is one Round. The last known Round is the latest on-chain Round known publicly.',
