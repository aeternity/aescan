export const transactionsHints = {
  ...
  keyblockConfirmations: 'Amount of keyblocks that were added since the transaction was produced.',
  ...
  nonce: 'Value of the nonce for the transaction. Nonce serves as a one-time authenticator per each transaction.',
  apiLinks: 'Links to sources of the transaction data.',
  sender: 'Account that dispatched the transaction.',
  recipient: 'Account that the transaction is transferred to.',
  amount: 'Amount of AE that was transferred.',
