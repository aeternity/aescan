export const transactionsHints = {
  ...
  gaAttachTxAccount: 'Account that has been converted into a generalized account. The authorization logic of the account is now handled by the smart contract that was attached to the account.',
  gaAttachTxSmartContractId: 'Unique identifier of the smart contract that has been attached to the account.',
