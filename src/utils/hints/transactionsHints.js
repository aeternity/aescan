export const transactionsHints = {
  transaction: 'Transaction is a record of value transfer or an operation execution that enables the participants to verify and confirm these actions on the blockchain.',
